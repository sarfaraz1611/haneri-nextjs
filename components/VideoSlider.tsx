...
const slides = [
  { id: "1147584196", title: "envo shot 21_9" },
  { id: "1147581103", title: "blowup 21_9" },
  { id: "1147584097", title: "rock one 1.2x" },
  { id: "1147584148", title: "aesthetic cinematics" },
  { id: "1147584196", title: "envo shot 21_9" },
  { id: "1147581103", title: "blowup 21_9" },
];
        ...
        {slides.map((slide, i) => (
          <div key={i} className="video-slide">
            <div
              ...
              style={{ backgroundImage: `url(${thumbnails[slide.id]})` }}
            />
            <iframe
              src={`https://player.vimeo.com/video/${slide.id}?autoplay=1&muted=1&loop=1&playsinline=1&controls=0&title=0&byline=0&portrait=0&background=1&autopause=0`}
